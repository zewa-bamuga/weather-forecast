...
async def get_users_list(
        query: UserManagementListQuery = Depends(wiring.Provide[Container.user.user_management_list_query]),
        pagination: pagination.PaginationCallable[schemas.User] = Depends(
            deps.get_skip_limit_pagination_dep(schemas.User)),
